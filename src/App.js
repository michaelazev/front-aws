            ...
            <header>
                <div className="section__container header__container" id="home">
                    <div className="header__content">
                        ...
                        <p>
                            Cada repetição te aproxima da sua melhor versão. A dor passa, o progresso fica. 
                            Quando quiser parar, lembre-se: é agora que a evolução acontece. Faça UMA A MAIS e conquiste!
                        </p>
                        ...
                        return (
                            <div key={unit.id} className="unit-card">
                                ...
                                <div className="unit-body">
                                    ...
                                    <div className="unit-button">{unit.status}</div>
                                </div>
                            </div>
                        );
                    })}
